<div class="col-md-4">
        <div class="product-content-right">
          <div class="woocommerce">
            ...
            <div class="woocommerce-info">Have a coupon? <a class="showcoupon" data-toggle="collapse" href="#coupon-collapse-wrap" aria-expanded="false" aria-controls="coupon-collapse-wrap">Click here to enter your code</a> </div>
            ...
            <?php include("v_order_review.php")?>
          </div>
        </div>
      </div>